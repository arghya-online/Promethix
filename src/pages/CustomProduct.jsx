      ...
      <div className="text-center max-w-3xl mx-auto space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-left py-12">
          {[
            ...
            <div
              key={item.step}
              className="p-6 bg-surface border border-border rounded-2xl group hover:border-primary/50 transition-colors"
            >
              <div className="w-10 h-10 bg-surface-light rounded-full flex items-center justify-center text-primary font-bold mb-4 group-hover:bg-primary group-hover:text-white transition-colors">
                {item.step}
              </div>
