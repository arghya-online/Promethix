...
export default function CustomProduct() {
  ...
  const openWhatsApp = async () => {
    ...
    try {
      ...
      console.log("CustomProduct: Logging custom consultation request to backend...");
      ...
      const orderNumber = resData.success ? resData.orderNumber : `PMX-CUST-${Date.now().toString().slice(-4)}`;
